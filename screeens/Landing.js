  ...
  return (
    <View style={{ flex:1,  justifyContent: 'center' }}>
      <ImageBackground source={backgroundImg} style={{flex:1,height:'100%',alignItems: "center" }}>
        <View style={{ backgroundColor: 'rgba(0, 0, 0, 0.7)',borderRadius:10, marginTop: 480, width: 390, height:320, padding: 20, borderRadius: 20 }}>
          ...
          <View style={{justifyContent:'center', alignItems:'center'}}>
            ...
            <TouchableOpacity onPress={()=>navigation.navigate('Login')} style={{ width: 150, height: 50, backgroundColor: '#091834', alignItems: 'center', justifyContent: 'center', borderRadius: 50 }}>
